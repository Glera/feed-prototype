...
- Создание и выбор/отклонение карточки — отдельные явные действия, без
  ...
  повтором POST или новым mutation ID. При недоступном storage действие
  не отправляется. Неопределённый исход не выдаётся за отказ или успех.
...
Конфликтующие request-deep-link'и не запускают обычную ленту вместо Research.
